...
/* All image URLs are built from src/lib/images.json — edit that file to swap any picture. */
const U = (id: string) => `${imagesData._baseUrl}${id}${imagesData._params}`;
const img = (q: string) => U(q);               // back-compat for inline IDs (none remain)
const cover = (k: string) => U((imagesData.vendorCovers as Record<string,string>)[k]);
const item = (k: string) => U((imagesData.menuItems as Record<string,string>)[k]);

/* Reliable per-category fallback photos (tier 2 of SmartImage). */
const F = imagesData.fallback as Record<string, string>;
...
export const MAMA_TITI_MENU: MenuSection[] = [
  {
    id: "rice", title: "Rice & Stew", items: [
      ...
      { id: "mt-r3", name: "Fried Rice + Turkey", description: "Seasoned fried rice with turkey drumstick", price: 2000, image: item("jollof-rice"), imageFallback: FALLBACK.rice, tags: ["Popular"] },
...
const COVENANT_MENU: MenuSection[] = [
  sec("soup", "Pepper Soups", [
    ...
    { id: "cp-4", name: "Chicken Pepper Soup", description: "Comforting, lightly peppered chicken broth", price: 2000, image: item("pepper-soup"), imageFallback: FALLBACK.soup },
  ]),
];
...
export const VENDORS: Vendor[] = [
  {
    ...
    cover: cover("mama-titi"), coverFallback: FALLBACK.rice,
    menu: MAMA_TITI_MENU,
  },
  {
    ...
    cover: cover("grace-grill"), coverFallback: FALLBACK.grill,
    menu: GRACE_MENU,
  },
  {
    ...
    cover: cover("bread-of-life"), coverFallback: FALLBACK.pastry,
    menu: BREAD_MENU,
  },
  {
    ...
    cover: cover("living-water"), coverFallback: FALLBACK.drink,
    menu: WATER_MENU,
  },
  {
    ...
    cover: cover("sister-bola"), coverFallback: FALLBACK.rice,
    menu: BOLA_MENU,
  },
  {
    ...
    cover: cover("kingdom-kitchen"), coverFallback: FALLBACK.snack,
    menu: KINGDOM_MENU,
  },
  {
    ...
    cover: cover("covenant-pepper"), coverFallback: FALLBACK.soup,
    menu: COVENANT_MENU,
  },
  {
    ...
    cover: cover("manna-suya"), coverFallback: FALLBACK.grill,
    menu: MANNA_MENU,
  },
  {
    ...
    cover: cover("chalet-cafe"), coverFallback: FALLBACK.snack,
    menu: CHALET_MENU,
  },
  {
    ...
    cover: cover("glory-shawarma"), coverFallback: FALLBACK.snack,
    menu: GLORY_MENU,
  },
];
