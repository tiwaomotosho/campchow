...
const Bike = createLucideIcon("bike", __iconNode$Y);
const __iconNode$X = [
...
const ChefHat = createLucideIcon("chef-hat", __iconNode$U);
...
const CornerDownRight = createLucideIcon("corner-down-right", __iconNode$M);
const __iconNode$L = [
...
const Soup = createLucideIcon("soup", __iconNode$e);
const __iconNode$d = [
  [
    "path",
    {
...
const Store = createLucideIcon("store", __iconNode$c);
const __iconNode$b = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
